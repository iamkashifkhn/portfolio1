    ...
    <div className='portfolio__project section__padding' id='projects'>
        ...
        <p>Here are few samples of my previous work &#128525;</p>
          <div className='portfolio__project-cards'>
              ...
              subtext='Portfolio is my personal portfolio website which is build by heart. It is open source and you are free to use the code as well from the Github link.'
